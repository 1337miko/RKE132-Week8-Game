string folderPath = @"/Users/miko/Documents";
string heroFile = "heroes.rtf";
string villainFile = "villains.rtf";
...
string hero = GetnRandomValueFromArray(heroes);
string heroWeapon = GetnRandomValueFromArray(weapon);
